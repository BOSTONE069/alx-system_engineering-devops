This is the configuration of the load balancer with two servers
...
* **2. Using Puppet for installation**
  * [Puppet configuration](2-puppet_custom_http_response_header.pp)